...
pdf("outputs/figures/01b_Feature_Histograms.pdf", width=12, height=8)
...
pdf("outputs/figures/01c_Bivariate_Features.pdf", width=12, height=8)
...
pdf("outputs/figures/02a_Dendrogram_Ward.pdf", width=12, height=7)
...
pdf("outputs/figures/02b_Silhouette_Ward.pdf", width=10, height=7)
library(cluster)
...
pdf("outputs/figures/02c_Silhouette_Genre.pdf", width=10, height=7)
...
pdf("outputs/figures/02_PCA_Scree.pdf", width=10, height=6)
...
pdf("outputs/figures/03_Q2_Model_Summary.pdf", width=12, height=9)
...
# Confusion matrices
pdf("outputs/figures/04_Confusion_Matrix_Phase3.pdf")
plot.new()
dev.off()

pdf("outputs/figures/05_Confusion_Matrix_Phase4.pdf")
plot.new()
dev.off()

pdf("outputs/figures/07_OneVsRest_AUC_BarPlot.pdf", width=10, height=6)
barplot(auc_values_ovr, names.arg=genres, main="One-vs-Rest AUC Values",
        col=colors, ylim=c(0,1))
dev.off()

pdf("outputs/figures/09_PCA_Variance_Table.pdf")
plot.new()
dev.off()
